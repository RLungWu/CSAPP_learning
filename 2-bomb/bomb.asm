...
0000000000400da0 <main>:
  400da0:	53                   	push   %rbx                       
  400da1:	83 ff 01             	cmp    $0x1,%edi                  # compare the number of arguments
...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp                    # allocate 8 bytes on the stack
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi               # move the address of the string to esi
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal>   # call the function strings_not_equal
  400eee:	85 c0                	test   %eax,%eax                    # test the return value # eas is the return value
...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp                 # 保留40个bits的空間 => why? 因為第一個會檢查是1，後續只需要檢查5個int，8 * 5 = 40
  400f02:	48 89 e6             	mov    %rsp,%rsi                  # move rsp => rsi => 用來儲存讀取的數字並傳到 read_six_numbers當中
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  # call read_six_numbers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                # compare the first number with 1 
  400f0e:	74 20                	je     400f30 <phase_2+0x34>      # if the first number is 1, jump to 400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>      
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>       
                                                                  # 循環開始的地方
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax            # move the number to eax aka 獲取前一個數字
  400f1a:	01 c0                	add    %eax,%eax                  # double it
  400f1c:	39 03                	cmp    %eax,(%rbx)                # 將double 以後的數字與原來的數字比較
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                  # 將 rbs 移動到下一個整數
  400f29:	48 39 eb             	cmp    %rbp,%rbx                  # 檢查是否已經檢查完5個整數 下面的循環。如果一樣的話，會執行下一行，否則會執行下下一行，跳出循環
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>      
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
                                                                  # 以下是一個循環，檢查5個int是否符合條件
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx             # 設置 rbs 為指向第二個整數的地址  (一開始的 40 Bits 空間)
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp            # 設置 rbp 為指向最後一個整數的地址
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>      
  400f3c:	48 83 c4 28          	add    $0x28,%rsp                 # 回收空間，與sub $0x28,%rsp對應
  400f40:	5b                   	pop    %rbx             # 回收rbx   
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   

0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp                     # allocate 24 bytes on the stack
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                 # move the address of the first number to rcx
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                 # move the address of the second number to rdx
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi                 # 0x4025cf = "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax                      # set eax to 0
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>   # call sscanf
  400f60:	83 f8 01             	cmp    $0x1,%eax                       # compare the return value with 1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>           # if the return value is greater than 1, jump to 400f6a
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                  # compare the first number with 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>            # if the first number is greater than 7, jump to 400fad
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                   # move the first number to eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)               # jump to the address in the jump table
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                       # 1st case
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>            
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax                      # 3rd case
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>            
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax                      # 4th case
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>            #
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax                      # 5th case
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                       # 6th case
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax                      # 7th case
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                      # 8th case
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax                      # 2nd case
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                 # move the address of the first number to rcx
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                  # move the address of the second number to rdx
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi                 # 0x4025cf = "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax                      # set eax to 0
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax                      # compare the return value with 2     eax must be 2   which is the return value of sscanf
  40102c:	75 07                	jne    401035 <phase_4+0x29>

  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)               
  401033:	76 05                	jbe    40103a <phase_4+0x2e>            # Jump if 0x8(%rsp) <= 0xe(14)
...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax              # compare the return value with 6 => The answer is 6 chars
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers> # The answer is 6 numbers
  ...
  40111b:	83 e8 01             	sub    $0x1,%eax                # Ensure read 6 numbers.
