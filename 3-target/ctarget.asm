...
00000000004017a8 <getbuf>:
  ...
  4017ac:	48 89 e7             	mov    %rsp,%rdi              # rdi = rsp   rdi points to the buffer rsp is the stack pointer
  4017af:	e8 8c 02 00 00       	callq  401a40 <Gets>          # call gets
...
0000000000401a40 <Gets>:
  401a40:	41 54                	push   %r12                       # save r12
  401a42:	55                   	push   %rbp                       # save rbp
  401a43:	53                   	push   %rbx                       # save rbx
  401a44:	49 89 fc             	mov    %rdi,%r12                  # r12 = rdi     rdi is the first argument, r12 is the buffer
  401a47:	c7 05 b3 36 20 00 00 	movl   $0x0,0x2036b3(%rip)        # 605104 <gets_cnt>     gets_cnt = 0
  401a4e:	00 00 00 
